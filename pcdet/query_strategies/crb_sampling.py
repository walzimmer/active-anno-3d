...
from pcdet.query_strategies.strategy import Strategy
...
class CRBSampling(Strategy):
    ...
    def query(self, leave_pbar=True, cur_epoch=None, use_test_set=False):
        ...
        if not use_test_set:
            select_dict['gradient_info'] = fc_grad_embedding_dict
