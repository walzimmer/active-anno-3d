...
class Strategy:
    def __init__(self, model, labelled_loader, unlabelled_loader, rank, active_label_dir, cfg):
        ...
        if cfg.DATA_CONFIG.DATASET == 'KittiDataset':
            ...
            self.pairs = list(zip(self.unlabelled_set.sample_id_list, self.unlabelled_set.tumtraf_infos))

        elif cfg.DATA_CONFIG.DATASET == 'HVLEDataset':
            self.pairs = list(zip(self.unlabelled_set.sample_id_list, self.unlabelled_set.hvle_infos))
    ...
    def save_active_labels(self, selected_frames=None, grad_embeddings=None, cur_epoch=None):
        ...
        if selected_frames is not None:
            ...
            # with open('/ahmed/output/test/class_weighted_selected_frames.pkl', 'wb') as f:
    ...
    def query(self, leave_pbar=True, cur_epoch=None, accumulated_iter=None):
        pass